...
public class StoreDetailsModel {
	...
	public StoreDetailsModel(int id, int storeId, String name, String addressline1, String addressline2, String city,
	...
	public String toString() {
		return "StoreDetailsModel [id=" + id + ", storeId=" + storeId + ", name=" + name + ", addressline1="
