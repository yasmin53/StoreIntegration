package com.usecase.storeprocessservice.entity;
...
public class StoreProcessEntity {
	...
	public StoreProcessEntity() {
		
	}
	
	public StoreProcessEntity(int id, int storeId, String name, String addressline1, String addressline2, String city,
