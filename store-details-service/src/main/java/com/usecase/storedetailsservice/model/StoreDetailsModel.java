package com.usecase.storedetailsservice.model;
...
public class StoreDetailsModel {
	...
	public StoreDetailsModel(int storeId, String addressline1, String addressline2, String city, String state,
			String country, int pincode, String holidayOn, String openCloseTimings, Date createdOn, String createdBy,
			Date updateOn, String updatedBy, boolean isActive) {
		super();
	...
	public String toString() {
		return "StoreDetailsModel [storeId=" + storeId + ", addressline1=" + addressline1 + ", addressline2="
				+ addressline2 + ", city=" + city + ", state=" + state + ", country=" + country + ", pincode=" + pincode
